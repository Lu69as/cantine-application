<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Glemmen_Kantine._Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main>
        <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 474.565 474.565" xml:space="preserve">
            <g>
        ...
        <h1>Meny</h1>
        <nav>
            <a alt="kald-mat">Kald Mat</a>
            <a alt="varm-mat">Varm Mat</a>
            <a alt="snacks">Snacks</a>
            <a alt="|">|</a>
            <a alt="energi-drikk">Energi Drikk</a>
            <a alt="varm-drikke">Varm Drikke</a>
            <a alt="kald-drikke">Kald Drikke</a>
        </nav>
        <section></section>
        <div id="Admin" class="adminVisible">
            <h1>Admin</h1>
            <input type="password" id="adminPassword" onkeypress="return event.keyCode != 13" />
            <div class="products">
            </div>
            <div class="addProducts">
                <input runat="server" id="add1" type="number" placeholder="ID (1)"/>
                <input runat="server" id="add2" type="text" placeholder="Name (Curry)"/>
                <input runat="server" id="add3" type="number" placeholder="Price (49)"/>
                <asp:DropDownList ID="add4" runat="server">
                    <asp:ListItem Selected="True" >Kategori Av Produkt</asp:ListItem>
                    <asp:ListItem>Kald Mat</asp:ListItem>
                    <asp:ListItem>Varm Mat</asp:ListItem>
                    <asp:ListItem>Snacks</asp:ListItem>
                    <asp:ListItem>Energi Drikk</asp:ListItem>
                    <asp:ListItem>Varm Drikke</asp:ListItem>
                    <asp:ListItem>Kald Drikke</asp:ListItem>
                </asp:DropDownList>
                <input runat="server" id="add5" type="text" placeholder="Allergies (Hvete, Egg)"/>
                <input runat="server" id="add6" type="text" placeholder="Image Link (https://www.website.domainEnding/image)"/>
                <asp:button ID="addFinal" OnClick="addProduct" Text="Add Product" runat="server"/>
            </div>
        </div>
    </main>

    <table ID="InvisListMat" runat="server"></table>
    <asp:button OnClick="removeProduct" cssClass="invisButton" runat="server"/>
    <asp:HiddenField runat="server" ID="productRemovalField"/>
</asp:Content>
